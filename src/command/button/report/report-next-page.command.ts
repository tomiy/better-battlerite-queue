...
async function execute(
    ...
    ensureContext(context, ['matchId', 'currentPage', 'listSize']);
...
function populateContext(
    ...
    const [matchId, currentPage, listSize] = options;
...
export const reportNextPage: ButtonCommand = {
    data: { name: 'reportNextPage' },
